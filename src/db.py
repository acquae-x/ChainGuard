...
def get_connection(url: str | None = None, tenant_id: str = "default") -> sqlite3.Connection:
    ...
    - postgresql://... opens psycopg with dict rows.
    """
    ...
    if database_url.startswith("postgresql://"):
        ...
        connection = psycopg.connect(database_url, row_factory=dict_row)  # type: ignore[assignment]
    ...
    raise ValueError(
        "Unsupported DATABASE_URL scheme. Use sqlite:///path or postgresql://..."
    )
