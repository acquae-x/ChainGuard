    ...
    <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#F5F6F8', padding: 24 }}>
      <Card style={{ width: 760 }}>
        ...
        <Form form={form} layout="vertical">
          ...
          {step === 1 && <>
            <Form.Item name="companyName" label="企业名称" rules={[{ required: true, message: '请输入企业名称' }]}><Select showSearch options={[{ label: '华东精密制造有限公司', value: '华东精密制造有限公司' }, { label: '长三角机器人集团', value: '长三角机器人集团' }]} /></Form.Item>
          ...
          {step === 2 && <>
            <Form.Item name="plan" initialValue="trial"><Radio.Group optionType="button" buttonStyle="solid" options={[{ label: '免费试用 30 天', value: 'trial' }, { label: '我有企业授权码', value: 'license' }]} /></Form.Item>
            <Form.Item noStyle shouldUpdate>{({ getFieldValue }) => getFieldValue('plan') === 'license' && <Form.Item name="license" label="企业授权码"><Input /></Form.Item>}</Form.Item>
