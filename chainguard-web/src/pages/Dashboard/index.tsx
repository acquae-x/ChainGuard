...
export default function DashboardPage() {
  ...
  const renderSection = (section: DashboardSection) => {
    ...
    if (section === 'approvalList') return <Card key={section} title="待会签列表"><Table size="small" rowKey="id" pagination={false} dataSource={approvals} columns={[{ title: '审批单', dataIndex: 'id' }, { title: '方案', dataIndex: 'summary' }, { title: '成本影响', render: (_, row) => <SensitiveField field="cost" value={`¥${row.costImpact.toLocaleString()}`} /> }]} /></Card>;
