...
export default function DashboardPage() {
  ...
  const KPI_SOURCE: Record<string, string> = { risk: 'riskCount', high: 'highRiskCount', approval: 'pendingApprovals', countersign: 'countersign', incident: 'incidentCount', overdue: 'overdueTasks', late: 'overdueTasks', mine: 'myTasks', task: 'myTasks' };
